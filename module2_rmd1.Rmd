...
```{r pressure2, echo=TRUE, fig.height=5, fig.width=5}
plot(pressure)
```
...
Here in inline footnote ^[Inline notes are easier to write, since you don't have to pick an identifier and move down to type the note.]
